...
namespace AppUtil
{
    public class AppUtil
    {
        ...
        public Hashtable OptsEntered
        {
            get
            {
                return this.optsEntered;
            }
            set
            {
                this.optsEntered = value;
            }
        }
        ...
        */
        ...
        public static AppUtil initialize(String name, OptionSpec[] userOptions, Hashtable args)
        {
        ...
        public static AppUtil initialize(String name, Hashtable args)
        {
